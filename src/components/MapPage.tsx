...
import {
  ...
  handleMapDrag,
  handlePoiSelect,
} from "../helpers/handleEnableSimulationFromBanner";
...
import { MobileBottomSheet, SheetSnap } from "./MobileBottomSheet";
import { HomePanelContent } from "./HomePanelContent";

// Lazy loaded heavy components
const CampusMap = React.lazy(() =>
  import("./Map").then((m) => ({ default: m.CampusMap })),
);
const CampusAssistant = React.lazy(() =>
  import("./CampusAssistant").then((m) => ({
