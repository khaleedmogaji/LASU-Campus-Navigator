...
export const WelcomeScreen: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-background text-foreground transition-colors duration-300 relative overflow-x-hidden flex flex-col justify-between">
