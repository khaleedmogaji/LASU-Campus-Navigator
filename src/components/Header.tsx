...
export const Header: React.FC<HeaderProps> = ({
  ...
  const { isRoutePlannerOpen, setIsRoutePlannerOpen, setSelectedPoi, setSheetSnap } = useNavigation();
      ...
      <div className="flex items-center gap-3 min-w-0">
        ...
        >
          <img 
            ...
            alt="LASU Logo" 
            className="w-12 h-12 object-contain shrink-0 drop-shadow-md transition-all duration-300 group-hover:scale-105"
            referrerPolicy="no-referrer"
          />
          <div className="shrink-0">
            <h1 className="font-black text-[16px] leading-tight tracking-tight text-zinc-900 transition-colors duration-300 group-hover:text-lasu-primary">LASU Navigator</h1>
