...
const INITIAL_POIS: POI[] = [
  ...
  {
    "id": "2",
    "name": "Babatunde Raji Fashola Senate House",
  ...
  {
    "id": "4",
    "name": "Fatiu Ademola Akesode Library (Main Library)",
  ...
  {
    "id": "13",
    "name": "School of Communication (LASUSOC)",
  ...
  {
    "id": "23",
    "name": "LASU Radio Station (95.7 FM)",
  ...
  {
    "id": "38",
    "name": "Access Bank LASU Campus Branch",
  ...
  {
    "id": "39",
    "name": "Wema Bank ATM (LASU Campus)",
  ...
  {
    "id": "50",
    "name": "LASU Staff School (Primary School)",
...
function AppContent() {
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2.5">
            {[
              ...
              { num: '02', icon: 'Layers', title: 'Change Map Themes', desc: 'Switch between Google Street and OpenStreetMap views via the Layers button.' },
            ].map((tip) => (
              <div 
                key={tip.num} 
  ...
  const LAYER_PREVIEWS = [
    { id: 'street' as MapStyle, label: 'Google Maps', desc: 'Standard street view', bg: 'from-sky-400 via-sky-300 to-emerald-200' },
  ...
  const filteredStartPois = startSearchQuery && startSearchQuery !== "My Location"
    ? pois.filter(p => p.name.toLowerCase().includes(startSearchQuery.toLowerCase()))
    : pois;

  const filteredEndPois = endSearchQuery && endSearchQuery !== "My Location"
    ? pois.filter(p => p.name.toLowerCase().includes(endSearchQuery.toLowerCase()))
    : pois;
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      <span className="text-[11px] font-bold text-zinc-700">
                        ({displayDistance.toFixed(2)} km • {routeInfo.segmentsCount} segments)
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-6 text-zinc-700">
                  ...
                  <div>
                    ...
                    <ul className="list-disc pl-5 space-y-2 text-sm">
                      <li>Interactive map with multiple styles (Street, Satellite, Dark)</li>
                  ...
                  <div>
                    ...
                    <div className="space-y-3 mt-2">
                      ...
                      <div className="bg-zinc-50 border border-zinc-200 rounded-xl p-3 text-xs leading-relaxed text-zinc-700 font-semibold">
                        <strong>🗺️ Toggle Map Themes</strong>: Use the Layers icon on the right to switch between Google Street and OpenStreetMap views.
                      </div>
                    </div>
                  </div>
                  <div>
            ...
            <div className="fixed inset-0 flex items-center justify-center p-4 pointer-events-none z-[4100]">
              ...
              >
                ...
                <p className="text-xs text-zinc-700 leading-relaxed font-semibold">
                  ...
                  {tourStep === 3 && "Use the controls on the right of the map: tap GPS to center and lock the camera on your position, or tap Layers to switch between the Google Street Map and OpenStreetMap pathways."}
